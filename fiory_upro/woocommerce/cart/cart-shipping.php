				...
				<?php foreach ( $available_methods as $method ) : ?>
                    ...
                    <li>
                        <div class="input-wrap-check">
                            ...
                            printf( '<label for="shipping_method_%1$s_%2$s"><span><b>%3$s</b></span> <span><b>%4$s</b></span></label>', $index, esc_attr( sanitize_title( $method->id ) ),   $method->get_label() , wc_price( $method->cost ) ); // WPCS: XSS ok.
