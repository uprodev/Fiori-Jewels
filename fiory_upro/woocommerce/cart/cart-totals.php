...
<div class="total-wrap <?= $args['class'] ?> cart_totals <?php echo ( WC()->customer->has_calculated_shipping() ) ? 'calculated_shipping' : ''; ?>">
	...
	<?php do_action( 'woocommerce_before_cart_totals' ); ?>
		...
		<?php foreach ( WC()->cart->get_coupons() as $code => $coupon ) : ?>
			<div class="total-line coupon-<?php echo esc_attr( sanitize_title( $code ) ); ?>">
				<p><?php wc_cart_totals_coupon_label( $coupon ); ?></p>
				<p><b><?php wc_cart_totals_coupon_html( $coupon ); ?></b></p>
			</div>
		<?php endforeach; ?>
		...
		<?php if ( WC()->cart->needs_shipping() && WC()->cart->show_shipping() ) : ?>
            ...
            <div class="total-line fee">
                <p>Shipping</p>
                <p><b><?= WC()->cart->get_cart_shipping_total() ?></b></p>
            </div>
		...
		<?php foreach ( WC()->cart->get_fees() as $fee ) : ?>
			<div class="total-line fee">
				...
				<p><b><?php wc_cart_totals_fee_html( $fee ); ?></b></p>
			</div>
		<?php endforeach; ?>
		...
		if ( wc_tax_enabled() && ! WC()->cart->display_prices_including_tax() ) {
			...
			if ( 'itemized' === get_option( 'woocommerce_tax_total_display' ) ) {
				foreach ( WC()->cart->get_tax_totals() as $code => $tax ) { // phpcs:ignore WordPress.WP.GlobalVariablesOverride.Prohibited
					?>
					<div class="total-line tax-rate tax-rate-<?php echo esc_attr( sanitize_title( $code ) ); ?>">
				...
				?>
				<div class="total-line tax-total">
		...
		<div class="total-line">
			...
			<p><b><?php wc_cart_totals_order_total_html(); ?></b></p>
		</div>
        ...
        <?php if (!$args['class']) { ?>
            ...
            <div class="total-btn">
                <a href="/shop" class="link"><i class="fas fa-chevron-left"></i>Back</a>
                <a href="<?php the_permalink(11) ?>" class="btn-default">CONTINUE TO CHECKOUT</a>
            </div>
